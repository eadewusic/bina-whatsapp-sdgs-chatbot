...
3. Familiarity with Python and Flask.
...
4. Update [openai_service.py](https://github.com/eadewusic/bina-whatsapp-sdgs-chatbot/blob/main/app/services/openai_service.py) to your use case.
5. Import `generate_reponse` into [whatsapp_utils.py](https://github.com/eadewusic/bina-whatsapp-sdgs-chatbot/tree/main/app/utils)
